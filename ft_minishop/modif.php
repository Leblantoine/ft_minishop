...
<li><a href="fonction/logout.php">Déconnection</a></li>
	...
	<body>
		<div class="body">
			<h1 class="center">Modifiez votre mot de passe</h1>
			<form class="center" action="fonction/modif.php" method="post">
				<p>Identifiant: <input type="text" name="login"></p>
				<p>Ancien mot de passe: <input type="password" name="oldpw"></p>
				<p>Nouveau mot de passe: <input type="password" name="newpw"></p>
