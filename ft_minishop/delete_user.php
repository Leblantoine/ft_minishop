...
<li><a href="fonction/logout.php">Déconnection</a></li>
	...
	<body>
		<div class="body">
			<h1 class="center">Supprimer un utilisateur</h1>
			<form class="center" action="fonction/delete_user.php" method="post">
			<p>Nom de l'utilisateur: <input type="text" name="user"></p>
